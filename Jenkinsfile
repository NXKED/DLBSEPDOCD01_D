pipeline {
    ...
    stages {
        stage('Checkout') {
          steps {
            git 'https://github.com/NXKED/DLBSEPDOCD01_D.git'
          }
        }
    ...
    post {
      always {
        mail to 'nik.breiter@iu-study.org', // Nachricht always an Email ueber Status des Builds. Alternativ mit 'failure'. Wechsel zu Slack tbd.
